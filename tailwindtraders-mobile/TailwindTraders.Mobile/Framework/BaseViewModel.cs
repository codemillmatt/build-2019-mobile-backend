...
namespace TailwindTraders.Mobile.Framework
{
    public abstract class BaseViewModel : INotifyPropertyChanged
    {
        ...
        public ICommand ShowCartCommand { get; } = new AsyncCommand(NavigateToCart);
        ...
        protected static async Task NavigateToCart()
        {
            var cartPage = new NavigationPage(new CartPage());

            await App.NavigateModallyToAsync(cartPage);
        }
