...
FUNCTION_NAME="$RESOURCE_PREFIX"function
...
az group deployment create -g $RESOURCE_GROUP_NAME --template-file azuredeploy.json --parameters prefix=$RESOURCE_PREFIX location=$MAIN_REGION functionLocation=$FUNCTION_REGION "sqlAdminPassword=$SQL_ADMIN_PASSWORD"
